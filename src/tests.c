...
test_ast_parse(void) {
    ...
    assert(root->type == NODE_TYPE_BIN);
    bin = root->real;
    assert(bin->lhs->type == NODE_TYPE_CODE_BLOCK);
    assert(bin->rhs == NULL);
    cbn = bin->lhs->real;
    assert(cbn->formula == NULL);
    ...
    assert(root->type == NODE_TYPE_BIN);
    bin = root->real;
    assert(bin->lhs->type == NODE_TYPE_TEXT_BLOCK);
    assert(bin->rhs == NULL);
    tbn = bin->lhs->real;
    assert(strcmp(tbn->text, "abc") == 0);
    ...
    fn = cbn->formula->real;
    assert(fn != NULL);
    assert(fn->lhs->type == NODE_TYPE_CALLER);
    cn = fn->lhs->real;
    assert(strcmp(cn->identifier_list[0], "func") == 0);
    ...
    assert(fn->lhs->type == NODE_TYPE_CALLER);
    cn = fn->lhs->real;
    assert(strcmp(cn->identifier_list[0], "alias") == 0);
    assert(strcmp(cn->identifier_list[1], "set") == 0);
    ...
    assert(strcmp(cn->identifier_list[0], "alias") == 0);
    assert(strcmp(cn->identifier_list[1], "set") == 0);
    assert(strcmp(cn->args[0], "dtl") == 0);
    assert(strcmp(cn->args[1], "run bin/date-line") == 0);
    ...
    fn = cbn->formula->real;
    assert(fn != NULL);
    assert(fn->lhs->type == NODE_TYPE_IMPORT);
    in = fn->lhs->real;
    assert(strcmp(in->package, "alias") == 0);
    ...
    bin = root->real;
    assert(bin->lhs->type == NODE_TYPE_CODE_BLOCK);
    assert(bin->rhs->type == NODE_TYPE_BIN);    
    cbn = bin->lhs->real;
    fn = cbn->formula->real;
    assert(fn != NULL);
    assert(fn->lhs->type == NODE_TYPE_IMPORT);
    in = fn->lhs->real;
    assert(strcmp(in->package, "aaa") == 0);
    bin2 = bin->rhs->real;
    assert(bin2->lhs->type == NODE_TYPE_CODE_BLOCK);
    assert(bin2->rhs == NULL);
    cbn = bin2->lhs->real;
    assert(cbn->formula != NULL);
    assert(cbn->formula->type == NODE_TYPE_FORMULA);
    fn = cbn->formula->real;
    assert(fn != NULL);
    assert(fn->lhs->type == NODE_TYPE_IMPORT);
    in = fn->lhs->real;
    assert(strcmp(in->package, "bbb") == 0);
    ...
    assert(bin->rhs->type == NODE_TYPE_BIN);
    tbn = bin->lhs->real;
    assert(strcmp(tbn->text, "aaa") == 0);
    bin2 = bin->rhs->real;
    assert(bin2->lhs->type == NODE_TYPE_CODE_BLOCK);
    assert(bin2->rhs->type == NODE_TYPE_BIN);
    cbn = bin2->lhs->real;
    fn = cbn->formula->real;
    assert(fn != NULL);
    assert(fn->lhs->type == NODE_TYPE_IMPORT);
    ...
    assert(fn->lhs->type == NODE_TYPE_IMPORT);
    in = fn->lhs->real;
    assert(strcmp(in->package, "ddd") == 0);
    bin = bin2->rhs->real;
    assert(bin->lhs->type == NODE_TYPE_TEXT_BLOCK);
    assert(bin->rhs == NULL);
    tbn = bin->lhs->real;
    assert(strcmp(tbn->text, "eee") == 0);
    ...
    in = fn->lhs->real;
    assert(strcmp(in->package, "alias") == 0);
    assert(fn->rhs->type == NODE_TYPE_FORMULA);
    fn2 = fn->rhs->real;
    assert(fn2->lhs->type == NODE_TYPE_CALLER);
    cn = fn2->lhs->real;
    assert(strcmp(cn->identifier_list[0], "alias") == 0);
    assert(strcmp(cn->identifier_list[1], "set") == 0);
    assert(strcmp(cn->args[0], "dtl") == 0);
