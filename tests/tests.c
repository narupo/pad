...
*/
    ...
    *******/
    ...
    tkr_parse(tkr, "{@ 1 @}");
    {
        ...
        assert(nodearr_get(multi_assign->nodearr, 0)->type == PAD_NODE_TYPE__TEST_LIST);
        ...
        assert(nodearr_get(test_list->nodearr, 0)->type == PAD_NODE_TYPE__TEST);
        ...
        assert(nodearr_get(or_test->nodearr, 0)->type == PAD_NODE_TYPE__AND_TEST);
